...
vim.api.nvim_create_autocmd('TextYankPost', {
  group    = vim.api.nvim_create_augroup('wndx_hi_on_yank', { clear = true }),
  pattern  = '*',
  callback = function()
...
vim.api.nvim_create_autocmd({ 'FileType' }, {
  group    = vim.api.nvim_create_augroup('wndx_formatoptions', { clear = true }),
  pattern  = '*',
  callback = function()
...
vim.api.nvim_create_autocmd({ 'VimEnter', 'ColorScheme' }, {
  group    = vim.api.nvim_create_augroup('wndx_hi_override', { clear = true }),
...
vim.api.nvim_create_autocmd({ 'VimEnter' }, {
  group    = vim.api.nvim_create_augroup('wndx_win_title_upd', { clear = true }),
  callback = function()
