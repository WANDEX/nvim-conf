...
let g:lt_location_list_toggle_map =
      \ get( g:, 'lt_location_list_toggle_map', '<leader>Ll' )
let g:lt_quickfix_list_toggle_map =
      \ get( g:, 'lt_quickfix_list_toggle_map', '<leader>Lq' )

execute "nnoremap <silent> " . g:lt_location_list_toggle_map . " :LToggle<CR>"
execute "nnoremap <silent> " . g:lt_quickfix_list_toggle_map . " :QToggle<CR>"
